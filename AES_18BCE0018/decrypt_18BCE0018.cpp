//Rahul 18BCE0018 Crypto Lab 3 Decrypt AES
#include <iostream>
#include <cstring>
#include <fstream>
#include <sstream>
...
int main() {
	...
	cout << "==========================================" << endl;
	cout << " 128-bit AES Decryption by Rahul 18BCE0018 " << endl;
	cout << "==========================================" << endl;

	// Read in the message from sample1.txt
	string msgstr;
	ifstream infile;
	infile.open("/home/rahul/Desktop/AES_18BCE0018/.gnupg/sample1.txt", ios::in | ios::binary);
